...
private extension AppModelTests {
    private func assertSanitizedLoad(
        ...
        XCTAssertNil(loadedSharedTitle.backdropURL)
        XCTAssertNil(loadedSharedTitle.trailerURL)
        XCTAssertNil(loadedSharedTitle.sourceURL)
        XCTAssertNil(loadedSharedTitle.reviews.first?.avatarURL)
        XCTAssertNil(loadedSharedTitle.reviews.first?.sourceURL)
        XCTAssertNil(loadedSharedTitle.seasons?.first?.artworkURL)
