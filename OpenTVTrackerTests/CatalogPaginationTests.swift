...
final class CatalogPaginationTests: XCTestCase {
    ...
    func testDiscoveryPaginationContinuesPastAnEmptySchedulePage() throws {
        let severance = try sampleTitle(id: "severance")
        ...
        try pagination.apply([severance], requestedPage: 2)
...
private actor DiscoveryCatalogPaginationStub: CatalogProviding {
    ...
    init(pages: [Int: [MediaTitle]], pageThatFailsOnce: Int) {
        self.pages = pages
