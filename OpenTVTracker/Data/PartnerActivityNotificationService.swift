...
actor PartnerActivityNotificationService: PartnerActivityNotifying {
    ...
    func notify(
        ...
        // Claim the planned IDs before the first await so a concurrent sync cannot
        // plan the same activity twice while these notifications are being posted.
    ...
    static func notifications(
        ...
        return activities
            .filter { activity in
                ...
                // Stale activity is not worth interrupting for, and a small amount of
                // future skew is expected when the partner's clock runs ahead of ours.
